    ...
    >
      {TABS.map(({ id, label, Icon }) => {
        ...
        return (
          ...
          >
            <Icon size={16} color={isActive ? 'var(--accent)' : 'var(--text3)'} strokeWidth={isActive ? 2.5 : 1.8} />
            <span style={{ fontSize: 9, color: isActive ? 'var(--accent)' : 'var(--text3)', fontWeight: isActive ? 600 : 400 }}>
              {label}
            </span>
          </button>
        );
